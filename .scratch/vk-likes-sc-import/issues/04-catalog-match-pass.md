...
- [x] Search via SoundCloudGateway and score/classify with strict Auto-Match rules
- [x] Match Records land in Auto / Ambiguous / Unresolved buckets
- [x] Progress feedback during a long match run
- [x] Session File updated with Match Records after the pass
- [x] Seam tests with fake catalog cover classification outcomes (external behavior)
- [x] Optional unit tests for pure normalize/score only where they reduce seam fixture noise
